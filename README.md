...
| Name | Description | AI | Online | Interface | Subcategory |
|------|-------------|----|--------|-----------|-------------|
| [AI](https://github.com/nitefood/ai-bash-gpt) | A command-line ChatGPT client in BASH with conversation/completion support | ✅ | ✅ | CLI | ChatGPT client |
| [AIChat](https://github.com/sigoden/aichat) | Using ChatGPT/GPT-3.5/GPT-4 in the terminal | ✅ | ✅ | CLI | AI terminal assistant |
| [Alibaba-CLI-Scraper](https://github.com/poneoneo/Alibaba-CLI-Scraper) | Create your own Alibaba dataset and interact with it in plain English | ✅ | ✅ | CLI | LLM wrapper |
| [ata](https://github.com/transformrs/ata) | Ask the Terminal Anything: OpenAI GPT in the terminal | ✅ | ✅ | CLI | AI terminal assistant |
